...
object DataMockup {
    ...
    val songbooks: MutableList<Songbook> by lazy {
        ...
        list.add(Songbook(getSongbookId(), "aaa", SongbookColor(255, 255, 0, 0)))
        list.add(Songbook(getSongbookId(), "bbb", SongbookColor(255, 0, 255, 0)))
        list.add(Songbook(getSongbookId(), "bbb", SongbookColor(255, 0, 0, 255)))
        list
    }
